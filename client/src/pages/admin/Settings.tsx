    ...
    <div className="max-w-5xl mx-auto">
      <Tabs defaultValue="hero" className="space-y-6">
        <TabsList className="bg-white border border-slate-200 p-1 rounded-2xl h-14 w-full sm:w-auto grid grid-cols-2">
          <TabsTrigger
            value="hero"
            className="rounded-xl data-[state=active]:bg-slate-900 data-[state=active]:text-white font-bold gap-2"
          >
        ...
        <TabsContent value="hero">
          <Card className="border-none shadow-sm overflow-hidden">
            <CardHeader className="bg-slate-50/50 border-b border-slate-100">
              ...
              <CardDescription>
                Kelola tulisan dan gambar yang muncul di bagian paling atas
                website.
              </CardDescription>
            </CardHeader>
            <CardContent className="p-8">
              <form onSubmit={handleHeroSubmit} className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <Textarea
                    id="title"
                    placeholder="RASAKAN KEPEDASAN HAKIKI."
                ...
                <Button
                  ...
                  className="w-full bg-slate-900 py-6 rounded-xl font-bold"
                >
        ...
        <TabsContent value="system">
          <Card className="border-none shadow-sm overflow-hidden">
            <CardHeader className="bg-slate-50/50 border-b border-slate-100">
              ...
              <CardDescription>
                Konfigurasi fitur pembayaran dan pengiriman.
              </CardDescription>
            </CardHeader>
            <CardContent className="p-8">
              <form onSubmit={handleSystemSubmit} className="space-y-8">
                <div className="flex items-center justify-between p-4 bg-slate-50 rounded-2xl border border-slate-100">
                  <div className="space-y-0.5">
                    ...
                    <p className="text-xs text-slate-500">
                      Gunakan simulasi pembayaran untuk pengujian di
                      localhost.
                    </p>
                  </div>
                  <Switch
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    <Label
                      htmlFor="packingFee"
                      className="text-xs font-bold text-slate-500 uppercase flex items-center gap-2"
                    >
                    ...
                    <Input
                      ...
                      onChange={e =>
                        setSystemFormData({
                          ...systemFormData,
                          packingFee: parseInt(e.target.value) || 0,
                        })
                      }
                      className="rounded-xl"
                    />
