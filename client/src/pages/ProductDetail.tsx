    ...
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <main className="flex-1 py-12 px-4">
        <div className="max-w-6xl mx-auto">
          <Link href="/catalog" className="inline-flex items-center text-red-600 hover:text-red-700 font-medium mb-8">
          ...
          {error && (
            <div className="bg-red-50 border border-red-200 rounded-lg p-12 text-center">
              <h2 className="text-2xl font-bold text-red-700 mb-2">Produk Tidak Ditemukan</h2>
              <p className="text-red-600 mb-6">Maaf, produk yang Anda cari tidak tersedia atau terjadi kesalahan.</p>
              <Link href="/catalog">
              ...
              <div className="flex flex-col">
                ...
                <div className="bg-gray-50 rounded-lg p-4 mb-6">
                  <div className="flex justify-between items-center mb-2">
                    <span className="text-gray-600 font-medium">Level Pedas</span>
                    <span className="text-xl">{renderSpiceLevel(product.spiceLevel)}</span>
                  </div>
