...
function Input({
  ...
  return (
    <input
      ...
      data-slot="input"
      className={cn(
        "file:text-foreground text-slate-900 font-bold placeholder:text-slate-500 placeholder:font-medium selection:bg-primary selection:text-primary-foreground dark:bg-input/30 border-slate-300 h-11 w-full min-w-0 rounded-xl border-2 bg-white px-4 py-2 text-base shadow-sm transition-all outline-none file:inline-flex file:h-7 file:border-0 file:bg-transparent file:text-sm file:font-medium disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-50 md:text-sm",
