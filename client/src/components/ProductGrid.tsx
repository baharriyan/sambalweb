  ...
  return (
    <div className="animate-fade-in-up">
      <div className="bg-transparent overflow-hidden flex flex-col h-full">
        <div className="relative aspect-[4/5] rounded-[2rem] overflow-hidden mb-6 bg-gradient-to-r from-slate-200 via-slate-100 to-slate-200 animate-shimmer" />
        <div className="p-0 space-y-3">
          ...
          <div className="flex items-center justify-between pt-4">
            <div className="h-7 w-28 bg-gradient-to-r from-slate-200 via-slate-100 to-slate-200 rounded animate-shimmer" />
      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
          ...
          <Button
            ...
            asChild
          >
            <Link href="/catalog">Lihat Semua Produk</Link>
          </Button>
        </div>
