...
- Accessibility Implementation Examples
  ...
  button_aria: `     <button aria-label="Close menu">
      <X className="w-6 h-6" />
    </button>
  `,

form_field: `     <label htmlFor="email">Email Address</label>
    <input 
      id="email" 
      type="email" 
...
skip_link: `     <a href="#main-content" className="sr-only focus:not-sr-only">
      Skip to main content
    </a>
  `,

heading_structure: `     <h1>Sambal E-Commerce</h1>
